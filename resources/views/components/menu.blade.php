...
<div class="max-w-screen-md">
        ...
        <div class="overflow-y-auto overflow-x-hidden flex-grow">
            <ul class="flex flex-col py-6 space-y-1 align-middle content-center">
                ...
                {{--Logout--}}
                <li>
                    <a href="/tasks" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-700 color-slime hover:text-gray-200 border-l-4 border-transparent hover:border-red-500 pr-6">

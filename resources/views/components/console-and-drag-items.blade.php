<div class="w-full gap-4 drag-and-drop m-4">
    <div class="w-full">
        <form wire:submit.prevent="submit">
            ...
            <div id="console" class="w-full border-slime border-solid color-slime h-auto relative rounded text-base border">
            </div>
            @error('dbCodeBlock')
    ...
    <div class="drag-container color-slime border-slime border rounded">
        ...
        <div id="code-snippets">
            <div data-value="value1" class="color-slime text-center text-2xl drag-item">
                <input type="hidden" value="value1" name="string1" />
            </div>
            <div data-value="value1gdsgdsg" class="color-slime text-center text-2xl drag-item">
                <input type="hidden" value="value1gdsgdsg" name="string1" />
            </div>
            <div data-value="if 1 = 2" class="color-slime text-center text-2xl drag-item">
                <input type="hidden" value="if 1 = 2" name="string1" />
            </div>
            <div data-value="if 1 = 2" class="color-slime text-center text-2xl drag-item">
                <input type="hidden" value="if 1 = 2" name="string1" />
            </div>
